      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link href="/forgot-password" className="text-[10px] font-bold text-slate-900 hover:text-emerald-600 transition-colors">
                Forgot Password?
              </Link>
            </div>
        ...
        <div className="text-center">
          <p className="text-slate-500 text-xs font-medium">
            ...
            <Link href="/register" className="text-slate-900 font-bold hover:text-emerald-600 transition-colors">
              Register
            </Link>
          </p>
        </div>
