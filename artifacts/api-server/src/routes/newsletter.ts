...
router.get("/newsletter/campaigns", (_req, res) => {
  res.json(campaigns);
});
...
router.put("/newsletter/campaigns/:id", (req, res) => {
...
router.delete("/newsletter/campaigns/:id", (req, res) => {
  campaigns = campaigns.filter((c) => c.id !== req.params.id);
  res.json({ ok: true });
});

router.post("/newsletter/campaigns/:id/resend", (req, res) => {
