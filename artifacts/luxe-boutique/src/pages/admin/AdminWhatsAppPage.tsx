              ...
              <div className="flex flex-col items-center justify-center py-20 gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-sm font-[Manrope] text-[#7c839b] max-w-sm">
                    WhatsApp Cloud API credentials are now managed centrally in Settings → Channels → WhatsApp.
                  </p>
                </div>
                <Link href="/admin/settings?section=whatsapp">
                ...
                {configuredCredsCount > 0 && (
                  <p className="text-xs font-[Manrope] text-[#006c49] font-bold flex items-center gap-1">
                    ...
                    {configuredCredsCount}/{WA_CRED_FIELDS.length} credentials already saved
                  </p>
                )}
              </div>
            )}
