              ...
              <div key={item.id} className="bg-white p-6 shadow-sm border border-slate-50 flex gap-6 rounded-lg transition-all hover:shadow-md">
                ...
                <div className="flex-1 flex flex-col justify-between py-2">
                  ...
                  <div className="flex justify-between items-end mt-8">
                    ...
                    <button onClick={() => removeItem(item.productId)} className="text-slate-400 hover:text-red-500 flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest">
          ...
          <div className="lg:col-span-4">
            <div className="bg-slate-50 p-8 rounded-xl sticky top-32 space-y-8">
              ...
              <div className="space-y-4 border-t border-slate-200 pt-6">
                <div className="flex justify-between text-slate-600"><span>Subtotal</span><span className="font-bold text-slate-900">{formatPrice(subtotal)}</span></div>
                <div className="flex justify-between text-slate-600"><span>Shipping</span><span className="text-emerald-600 font-bold uppercase text-[10px] tracking-widest">Complimentary</span></div>
              ...
              <Link href="/checkout" className="w-full bg-slate-900 text-white py-5 rounded-none font-bold uppercase tracking-widest text-xs flex items-center justify-center space-x-3 hover:bg-emerald-600 transition-all">
