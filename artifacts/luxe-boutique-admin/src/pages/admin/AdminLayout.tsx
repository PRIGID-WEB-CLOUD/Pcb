...
const mainNavItems = [
  ...
  { icon: "inventory_2",  label: "Catalog",    href: "/catalog"      },
  ...
  { icon: "sell",         label: "Coupons",    href: "/coupons"      },
  { icon: "analytics",    label: "Analytics",  href: "/analytics"    },
  { icon: "photo_library", label: "Media",     href: "/media"        },
  { icon: "article",      label: "Journal",    href: "/blog"         },
  { icon: "mail",         label: "Newsletter", href: "/newsletter"   },
  { icon: "hub",          label: "Channels",   href: "/channels"     },
  { icon: "extension",    label: "Providers",  href: "/providers"    },
  { icon: "group_add",    label: "Team",       href: "/team"         },
  { icon: "settings",     label: "Settings",   href: "/settings"     },
];

const channelNavItems = [
  { icon: "hub",          label: "Channel Hub",    href: "/channels"                },
  { icon: "thumb_up",     label: "Facebook Pages", href: "/channels/facebook"       },
  { icon: "photo_camera", label: "Instagram",      href: "/channels/instagram"      },
  { icon: "storefront",   label: "Meta Commerce",  href: "/channels/meta-commerce"  },
  { icon: "campaign",     label: "Meta Ads",       href: "/channels/meta-ads"       },
  { icon: "chat",         label: "WhatsApp API",   href: "/channels/whatsapp"       },
      ...
      <aside className={`admin-sidebar fixed left-0 top-0 h-screen ${sidebarW} bg-slate-50 border-r border-slate-200 flex flex-col z-40 overflow-hidden`}>
        ...
        <div className="mt-auto border-t border-slate-200 px-2 py-3 space-y-0.5">
          {sidebar === "channels" ? (
            ...
            <>
              <Link href="/settings" title="Settings" className={`flex items-center gap-3 py-3 text-slate-500 hover:bg-slate-100 hover:text-slate-900 transition-all font-serif text-sm uppercase tracking-wider rounded-sm ${collapsed ? "justify-center px-2" : "px-4"}`}>
